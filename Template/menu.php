<!-- <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto mx-auto">
          ...
          <li class="nav-item">
            <a class="nav-link " href="#" >TeamPAD</a>
          </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
              <a class="dropdown-item" href="#">Vos adresses</a>
              <a class="dropdown-item" href="#">Vos commandes</a>
              <a class="dropdown-item" href="#">Vos envies</a>
              <a class="dropdown-item" href="#">Vos paiements</a>
              <a class="dropdown-item" href="#">Modification informations personnelles</a>
            </div>
        </li> 
      </div>
    </nav>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
              <a class="dropdown-item" href="View/ProfilView.php">Evénements</a>
              <a class="dropdown-item" href="#">Chronique</a>
            </div>
          </li>
        </ul>
        <div class="row justify-content-center">
          <div class="">
            <form class="form-inline my-2 my-lg-0">
              <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
              <button class="btn btn-sm btn-submit-navbar  my-2 my-lg-0" type="submit" style="color : #ffffff">Go!</button>
            </form>
          </div>
          <div class="col0">
            <ul class="navbar-nav ml-auto second-linkList">
              <li class="nav-item">
                <a class="nav-link" href="View/AccountView.php">
